var MathImg = /** @class */ (function () {
    ...
    // funcion color morado
    MathImg.tomorado = function (img) {
        //variable que guarda el arreglo 3d de la imagen de color
        var arrImage = img.getArrayImg();
        //variable donde guardamos la salida
        var sal = this.initArray(img.getWidth(), img.getHeight());
    ...
    //funcion resaltar color rojo
    MathImg.torrojo = function (img) {
        //variable que guarda el arreglo 3d de la imagen de color
        var arrImage = img.getArrayImg();
        //variable donde guardamos la salida
        var sal = this.initArray(img.getWidth(), img.getHeight());
    ...
    //funcion resaltar color azul
    MathImg.torazul = function (img) {
        //variable que guarda el arreglo 3d de la imagen de color
        var arrImage = img.getArrayImg();
        //variable donde guardamos la salida
        var sal = this.initArray(img.getWidth(), img.getHeight());
        ...
        for (var i = 0; i < img.getHeight(); i++) {
            for (var j = 0; j < img.getWidth(); j++) {
                if (arrImage[0][i][j]<100 && arrImage[1][i][j] < 120 && arrImage[2][i][j]>60) {
                sal[0][i][j] = 0;
                sal[1][i][j] = 0;
                sal[2][i][j] = 250;   
                }
    ...
    // Efecto colores 
    MathImg.toColores= function (img) {
        //variable que guarda el arreglo 3d de la imagen de color
        var arrImage = img.getArrayImg();
        //variable donde guardamos la salida
        var sal = this.initArray(img.getWidth(), img.getHeight());
